...
const pages = [
  ...
  {
    path: "pages/WordExercise/WordExercise",
    style: {
      navigationStyle: "custom"
    }
  },
  {
    path: "pages/WordProgress/WordProgress",
    style: {
      navigationStyle: "custom"
    }
  },
  {
    path: "pages/WordLearning/WordLearning",
    style: {
      navigationStyle: "custom"
    }
  }
...
const tabBar = {
  ...
  list: [
    ...
    },
    {
      ...
      text: "我的",
      iconPath: "static/self.png",
      selectedIconPath: "static/self-h.png"
    }
  ]
};
const uniIdRouter = {};
...
const S = true, b = "mp-weixin", A = I(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), C = b, P = I('{"address":["127.0.0.1","10.125.79.156"],"servePort":7000,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","D:/app/HBuilderX.4.24.2024072208/HBuilderX/plugins/unicloud/**/*.js"]}'), T = I('[{"provider":"aliyun","spaceName":"space","spaceId":"mp-1b47c885-9e6e-4886-9d10-f2ddaa69adde","clientSecret":"MjgFfZrs1pVVCIyAvJJJrg==","endpoint":"https://api.next.bspapp.com"}]') || [];
let O = "";
try {
  O = "__UNI__A0F621F";
} catch (e2) {
