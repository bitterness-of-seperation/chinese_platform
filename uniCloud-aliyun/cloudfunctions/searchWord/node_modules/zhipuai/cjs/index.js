...
(function (ModelType) {
    ...
    ModelType["ChatGLMTurbo"] = "chatglm_turbo";
    ModelType["CharacterGLM"] = "characterglm";
...
class ZhipuAI {
    ...
    buildRequestBody(options) {
        if (options.model === exports.ModelType.CharacterGLM) {
            return {
        ...
        if (options.model === exports.ModelType.TextEmbedding) {
            return {
